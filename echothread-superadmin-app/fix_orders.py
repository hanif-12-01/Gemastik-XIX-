          ...
          <table className=\"w-full\">
            <thead className=\"bg-gray-50\">
              <tr>
                ...
                <th className=\"px-4 py-3 text-left text-xs font-semibold text-gray-600 uppercase\">Dispatch Action (Simulasi Demo)</th>
              </tr>
            </thead>
...
c = re.sub(r'const OrdersView = \(\) => \([\s\S]*?  // AI Digitization View', replacement + '\n\n  // AI Digitization View', c, count=1)
